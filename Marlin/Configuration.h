 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, 5, -.85 }
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_TYPE   NEO_BGR + NEO_KHZ800// NEO_GRBW / NEO_GRB - four/three channel driver type (defined in Adafruit_NeoPixel.h)
